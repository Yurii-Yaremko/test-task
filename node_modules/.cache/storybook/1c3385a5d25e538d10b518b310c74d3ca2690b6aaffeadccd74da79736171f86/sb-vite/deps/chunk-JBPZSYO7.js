...
var la = _((bp, bs) => {
  (function(e) {
    ...
    return a(function n(o, i, l) {
      ...
      a(u, "s");
      for (var c = typeof na == "function" && na, p = 0; p < l.length; p++)
        u(l[p]);
      return u;
    }, "e")({ 1: [function(n, o, i) {
...
function l2(e, t) {
  var r;
  if (e.type === "text" || e.type === "comment" || Xi(e) || e.type === "yaml" || e.type === "toml")
    return null;
  if (e.type === "attribute" && delete t.value, e.type === "docType" && delete t.value, e.type === "angularControlFlowBlock" && (r = e.parameters) != null && r.children)
    for (let n of t.parameters.children)
      Wx.has(e.name) ? delete n.expression : n.expression = n.expression.trim();
...
function EC(e, t) {
  ...
  if (e.type === "element" && e.namespace === "svg")
    if (CC(e, (o) => o.fullName === "svg:foreignObject"))
      n = true;
    else
...
async function kC(e, t) {
  let r = [];
  for (let [n, o] of e.split(x2).entries())
    if (n % 2 === 0)
      r.push(dt(o));
    else
      try {
...
function IC(e, t) {
  ...
  let o = ir(r);
  if (/^i18n(?:-.+)?$/u.test(n))
    return () => Ki(i2(y2(r, o.trim())), !o.includes("@@"));
  if (x2.test(o))
    return (i) => kC(o, i);
}
function _C(e, t) {
...
function jC(e) {
  ...
  function h7() {
    for (p(HC), o = "", i = "in descriptor"; ; ) {
      if (l = e.charAt(u), i === "in descriptor")
        if (R5(l))
        ...
        if (l === ")")
          ...
          o += l;
      else if (i === "after descriptor" && !R5(l))
        if (l === "") {
          f();
          return;
        } else
  ...
  function f() {
    ...
    for (y = 0; y < n.length; y++)
      D4 = n[y], x = D4[D4.length - 1], C = D4.substring(0, D4.length - 1), E = parseInt(C, 10), R = parseFloat(C), S5.test(C) && x === "w" ? ((b || m) && (v = true), E === 0 ? v = true : b = E) : $C.test(C) && x === "x" ? ((b || m || g) && (v = true), R < 0 ? v = true : m = R) : S5.test(C) && x === "h" ? ((g || m) && (v = true), E === 0 ? v = true : g = E) : v = true;
    if (!v)
      w.source = { value: r, startOffset: c }, b && (w.width = { value: b }), m && (w.density = { value: m }), g && (w.height = { value: g }), d.push(w);
    else
      throw new Error(`Invalid srcset descriptor found in "${e}" at "${D4}".`);
  }
  a(f, "d");
}
function WC(e) {
...
function YC(e, t) {
  ...
  if (r.fullName === "style" && !t.parentParser && !n.includes("{{"))
    return async (o) => Ki(await o(n, { parser: "css", __isHTMLStyleAttribute: true }));
}
function XC(e, t) {
  let { root: r } = e;
...
function tE(e, t) {
  ...
  if (n === "v-for")
    return QC;
  if (n === "generic" && D2(r.parent, t))
    return KC;
  let o = ir(r), i = fc(e, t);
  if (AC(r) || FC(r, t))
    return (l) => ZC(o, l, { parseWithTs: i });
  if (n.startsWith("@") || n.startsWith("v-on:"))
    return (l) => rE(o, l, { parseWithTs: i });
  if (n.startsWith(":") || n.startsWith("v-bind:"))
    return (l) => nE(o, l, { parseWithTs: i });
  if (n.startsWith("v-"))
    return (l) => E2(o, l, { parseWithTs: i });
}
...
function iE(e) {
  return async (t, r, n, o) => {
    ...
    if (i)
      return i = uc(i, (l) => typeof l == "string" ? Ge(false, l, '"', "&quot;") : l), [n.node.rawName, '="', fe(i), '"'];
  };
}
function sE(e) {
  ...
  return e.map((i, l) => {
    ...
    if (rt(u)) {
      if (u.prev && rt(u.prev)) {
        let b = Ti(u.prev, u);
        if (b)
          return Li(u.prev) ? [Q, Q, wa(i, t, r)] : [b, wa(i, t, r)];
      }
      return wa(i, t, r);
    }
...
function ME(e, t, r) {
  let { node: n } = e;
  if (u2(n, t))
    return [zr(n, t), fe(Zu(e, t, r)), dt(F2(n, t)), ...Ku(n, t), Pr(n, t)];
...
function KE(e, t) {
  e.walk((r) => {
    ...
    if (n) {
      ...
      for (let o of n)
        o.isLeadingSpaceSensitive = uC(o, t), o.isTrailingSpaceSensitive = cC(o, t);
...
function z2(e, t, r) {
  ...
  let f = a((w) => {
    ...
    switch (w.type) {
      case "element":
        f(w);
        for (let D4 of w.attrs)
          f(D4), D4.valueSpan ? (D4.value = D4.valueSpan.toString(), /["']/u.test(D4.value[0]) && (D4.value = D4.value.slice(
            1,
            -1
          ))) : D4.value = null;
        break;
    ...
    if (w.type === "element" && (i && (!w.namespace || w.namespace === w.tagDefinition.implicitNamespacePrefix || Ra(w)) && (w.name = b(
      ...
      for (let D4 of w.attrs)
        D4.namespace || (D4.name = b(D4.name, (x) => Xu.has(w.name) && (Xu.get("*").has(x) || Xu.get(
          w.name
        ).has(x))));
  }, "D"), g = a((w) => {
...
var j2 = A(() => {
  gx = Object.defineProperty, J5 = a((e) => {
    ...
    for (var r in t)
      gx(e, r, { get: t[r], enumerable: true });
...
` && ++u == r)); )
  ...
  oR = (_n = class {
    ...
    hasProperty(t, r, n) {
      if (n.some((o) => o.name === M5.name))
        return true;
      if (t.indexOf("-") > -1) {
        if (P5(t) || H5(t))
          return false;
        if (n.some((o) => o.name === I5.name))
          return true;
      }
...
`);
    ...
    _consumeBlockStart(t) {
      ...
      if (this._cursor.peek() === 40)
        if (this._cursor.advance(), this._consumeBlockParameters(), this._attemptCharCodeUntilFn(ue), this._attemptCharCode(
          41
        ))
    ...
    _consumeLetDeclaration(t) {
      if (this._beginToken(30, t), Hi(this._cursor.peek()))
        this._attemptCharCodeUntilFn(ue);
      else {
    ...
    _tokenizeExpansionForm() {
      ...
      if (IR(this._cursor.peek()) && this._isInExpansionForm())
    ...
    _endToken(t, r) {
      ...
      if (this._currentTokenType === null)
        throw new Uu("Programming error - attempted to end a token which has no token type", null, this._cursor.getSpan(this._currentTokenStart));
    ...
    handleError(t) {
      if (t instanceof Dc && (t = this._createError(t.msg, this._cursor.getSpan(t.cursor))), t instanceof Gu)
    ...
    _consumeEntity(t) {
      ...
      if (this._cursor.advance(), this._attemptCharCode(35)) {
        ...
        let n = this._cursor.clone();
        if (this._attemptCharCodeUntilFn(BR), this._cursor.peek() != 59)
          ...
          let i = $i[o];
          if (!i)
            throw this._createError(j5(o), this._cursor.getSpan(r));
          this._endToken([i, `&${o};`]);
        }
      }
    }
    ...
    _consumePrefixAndName() {
      ...
      for (; this._cursor.peek() !== 58 && !LR(this._cursor.peek()); )
        this._cursor.advance();
      let n;
    ...
    _consumeTagClose(t) {
      if (this._beginToken(3, t), this._attemptCharCodeUntilFn(ue), this._allowHtmComponentClosingTags && this._attemptCharCode(47))
  ...
  H2 = (or = class {
    ...
    advanceState(t) {
      if (t.offset >= this.end)
        throw this.state = t, new Dc('Unexpected character "EOF"', this);
    ...
    processEscapeSequence() {
      ...
      if (t() === 92)
        if (this.internalState = { ...this.state }, this.advanceState(this.internalState), t() === 110)
          ...
          yc(this.internalState.peek) ? (this.advanceState(this.internalState), this.state = this.internalState) : this.state.peek = this.internalState.peek;
    }
    decodeHexDigits(t, r) {
      let n = this.input.slice(t.internalState.offset, t.internalState.offset + r), o = parseInt(n, 16);
      if (isNaN(o))
        throw t.state = t.internalState, new Dc("Invalid hexadecimal escape sequence", t);
      return o;
    }
    ...
    build() {
      ...
      for (let t of this._containerStack)
        t instanceof An && this.errors.push(Ie.create(t.name, t.sourceSpan, `Unclosed block "${t.name}"`));
    }
    _advance() {
      let t = this._peek;
    ...
    _parseExpansionCase() {
      ...
      if (this._peek.type !== 22)
        return this.errors.push(Ie.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null;
      ...
      for (; ; ) {
        if ((this._peek.type === 20 || this._peek.type === 22) && n.push(this._peek.type), this._peek.type === 23)
          if (G5(n, 22)) {
            ...
            return this.errors.push(Ie.create(null, t.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
        if (this._peek.type === 24)
          if (G5(n, 20))
            n.pop();
          else
...
`) {
      ...
      for (; this._peek.type === 8 || this._peek.type === 5 || this._peek.type === 9; )
        t = this._advance(), r.push(t), t.type === 8 ? o += t.parts.join("").replace(/&([^;]+);/g, Y5) : t.type === 9 ? o += t.parts[0] : o += t.parts.join("");
      if (o.length > 0) {
        let i = t.sourceSpan;
    ...
    _consumeEndTag(t) {
      ...
      if (r && this.getTagDefinition(r).isVoid)
        this.errors.push(Ie.create(r, t.sourceSpan, `Void elements do not have end tags "${t.parts[1]}"`));
    ...
    _popContainer(t, r, n) {
      ...
      for (let i = this._containerStack.length - 1; i >= 0; i--) {
        ...
        if (Mi(l.name) ? l.name === t : (t == null || l.name.toLowerCase() === t.toLowerCase()) && l instanceof r)
    ...
    _consumeAttr(t) {
      ...
      if (this._peek.type === 16)
        for (u = this._peek.sourceSpan, c = this._peek.sourceSpan.end; this._peek.type === 16 || this._peek.type === 17 || this._peek.type === 9; ) {
          let d = this._advance();
    ...
    _getClosestParentElement() {
      for (let t = this._containerStack.length - 1; t > -1; t--)
        if (this._containerStack[t] instanceof nr)
  ...
  UR = qR, Ii = { attrs: true, children: true, cases: true, expression: true }, K5 = /* @__PURE__ */ new Set(["parent"]), GR = (Et = class {
    constructor(t = {}) {
      for (let r of /* @__PURE__ */ new Set([...K5, ...Object.keys(t)]))
  ...
  for (var u = 0, c = i.length, p = 0, d = 0; u < c; u++) {
    ...
    if (h7.removed) {
      ...
      if (!h7.added && o) {
        ...
        h7.value = e.join(r.slice(p, p + h7.count));
...
function Fc(e, t, r, n, o) {
  ...
  if (e && e.toJSON && (e = e.toJSON()), ll(e) === "object" && e !== null) {
    ...
    var u = [], c;
    for (c in e)
      e.hasOwnProperty(c) && u.push(c);
    for (u.sort(), i = 0; i < u.length; i += 1)
      c = u[i], l[c] = Fc(e[c], t, r, n, c);
    t.pop(), r.pop();
  } else
    l = e;
  return l;
    ...
    if ((t == null ? void 0 : t(i)) !== false)
      switch (l) {
        ...
        case kt: {
          ...
          for (let c = u.length, p = c - 1; p >= 0; --p)
            o.push(u[p]);
          break;
        }
        case Ye:
        ...
        case Ve:
          if (n && i.expandedStates)
            for (let u = i.expandedStates.length, c = u - 1; c >= 0; --c)
...
function qS(e) {
  ...
  function n(i, l, u) {
    ...
    if (i.type === nt)
      return ((p = u == null ? void 0 : u[l - 1]) == null ? void 0 : p.type) === Se && u[l - 1].hard ? void 0 : "breakParent";
    if (i.type === $t)
      return "trim";
    if (i.type === Ot)
...
function QS(e) {
  if (e.type === Ve && e.break || e.type === Se && e.hard || e.type === nt)
    return true;
}
function eA(e) {
...
function G2(e) {
  for (e = [...e]; e.length >= 2 && ye(false, e, -2).type === Se && ye(false, e, -1).type === nt; )
    e.length -= 2;
  if (e.length > 0) {
          ...
          case je: {
            ...
            if (!b.break && il(m, l, g, y, r))
              ...
              if (b.break) {
                ...
                for (let D4 = 1; D4 < b.expandedStates.length + 1; D4++)
                  if (D4 >= b.expandedStates.length) {
                    l.push({ ind: f, mode: je, doc: w });
                    break;
                  } else {
              ...
              l.push({ ind: f, mode: je, doc: b.contents });
            break;
          }
        }
...
function RA(e, t) {
  let { comments: r } = e;
  if (delete e.comments, !DA(r) || !t.printer.canAttachComment)
    return;
  ...
  for (let [v, b] of f.entries()) {
    ...
    let R;
    if (l ? R = [b] : (m.enclosingNode = y, m.precedingNode = g, m.followingNode = w, R = [m, D4, x, C, E]), SA(D4, x, f, v))
      m.placement = "ownLine", p(...R) || (w ? co(w, m) : g ? po(g, m) : $r(y || C, m));
    else if (AA(D4, x, f, v))
      m.placement = "endOfLine", d(...R) || (g ? po(g, m) : w ? co(w, m) : $r(y || C, m));
    else if (m.placement = "remaining", !h7(...R))
      if (g && w) {
        let F = n.length;
        F > 0 && n[F - 1].followingNode !== w && Y2(n, x), n.push(b);
      } else
        g ? po(g, m) : w ? co(w, m) : $r(y || C, m);
  }
  if (Y2(n, t), !l)
    for (let v of r)
...
function Y2(e, t) {
  ...
  for (let [p, { comment: d }] of e.entries())
    p < c ? po(i, d) : co(l, d);
  for (let p of [i, l])
    p.comments && p.comments.length > 1 && p.comments.sort((d, h7) => t.locStart(d) - t.locStart(h7));
  e.length = 0;
}
function Ec(e, t, r) {
...
function TA(e, t) {
  ...
  if ((r.comments || []).filter((u) => !n.has(u)).length === 0)
...
function Um({ plugins: e = [], showDeprecated: t = false } = {}) {
  ...
  for (let o of zA(Object.assign({}, ...e.map(({ options: i }) => i), PA)))
    !t && o.deprecated || (Array.isArray(o.choices) && (t || (o.choices = o.choices.filter((i) => !i.deprecated)), o.name === "parser" && (o.choices = [...o.choices, ...HA(o.choices, r, e)])), o.pluginDefaults = Object.fromEntries(e.filter((i) => {
      var l;
...
function qA(e, t) {
  ...
  for (; d < n; )
    tm[d] = e.charCodeAt(i + d), Rc[d] = ++d;
  for (; h7 < o; )
    for (l = t.charCodeAt(i + h7), c = h7++, u = h7, d = 0; d < n; d++)
      p = l === tm[d] ? c : c + 1, c = Rc[d], u = Rc[d] = c > u ? p > u ? u + 1 : p : p > c ? c + 1 : p;
  return u;
}
function GA(e, t) {
  let r = new e(t), n = Object.create(r);
  for (let o of UA)
    o in t && (n[o] = YA(t[o], r, ur.prototype[o].length));
  return n;
}
function YA(e, t, r) {
...
function gF(e, { isCLI: t, FlagSchema: r }) {
  ...
  for (let o of e)
    n.push(vF(o, { isCLI: t, optionInfos: e, FlagSchema: r })), o.alias && t && n.push(XA.create({ name: o.alias, sourceName: o.name }));
  return n;
}
...
async function xF(e, t = {}) {
  ...
  if (!n.parser)
    if (n.filepath) {
      if (n.parser = jA(n, { physicalFile: n.filepath }), !n.parser)
        throw new X2(`No parser could be inferred for file "${n.filepath}".`);
    } else
      throw new X2("No parser and no file path given, couldn't infer a parser.");
  ...
  for (let [f, v] of Object.entries(h7))
    (n[f] === null || n[f] === void 0) && (n[f] = v);
...
async function SF(e, t, r, n, o) {
  ...
  v();
  let h7 = e.stack;
  for (let { print: b, node: m, pathStack: g } of d)
    try {
      e.stack = g;
  ...
  function v() {
    let { node: b } = e;
    if (b === null || typeof b != "object" || u(e))
      return;
    for (let g of p(b))
      Array.isArray(b[g]) ? e.each(v, g) : e.call(v, g);
    let m = l(e, r);
    if (m) {
...
function LF(e, t) {
  ...
  for (let c of gA(e, { getVisitorKeys: i, filter: l }))
    u = c;
  return u;
}
function BF(e, t) {
  ...
  function l(u, c) {
    if (!(u !== null && typeof u == "object"))
      return u;
    if (Array.isArray(u))
      return u.map((f) => l(f, c)).filter(Boolean);
    let p = {}, d = new Set(o(u));
    for (let f in u)
      !Object.prototype.hasOwnProperty.call(u, f) || i.has(f) || (d.has(f) ? p[f] = l(u[f], u) : p[f] = u[f]);
    let h7 = r(u, p, c);
    if (h7 !== null)
      return h7 ?? p;
  }
...
function $F(e, t, r) {
  ...
  if (PF(t)) {
    ...
    ({ startNode: h7, endNode: f } = zF(p, d, t));
...
async function ag(e, t, r = 0) {
  ...
  if (t.cursorOffset >= 0) {
    let c, p, d, h7, f;
    if (t.cursorNode && l.cursorNodeText ? (c = t.locStart(t.cursorNode), p = o.slice(c, t.locEnd(t.cursorNode)), d = t.cursorOffset - c, h7 = l.cursorNodeStart, f = l.cursorNodeText) : (c = 0, p = o, d = t.cursorOffset, h7 = 0, f = l.formatted), p === f)
      return {
...
async function lg(e, t) {
  ...
  if (o.rangeStart >= o.rangeEnd && n !== "" || o.requirePragma && !await mm(n, o))
...
function ek(e, t) {
  let r = null, n = t;
  for (; n !== r; )
    r = n, n = sr(e, n), n = Xc(e, n), n = Kc(e, n), n = Wr(e, n);
  return n;
}
function tk(e, t) {
  let r = null, n = t;
  for (; n !== r; )
    r = n, n = Om(e, n), n = Xc(e, n), n = sr(e, n);
...
var fg = A(() => {
  cS = Object.create, dl = Object.defineProperty, pS = Object.getOwnPropertyDescriptor, dS = Object.getOwnPropertyNames, fS = Object.getPrototypeOf, hS = Object.prototype.hasOwnProperty, gm = a((e) => {
    ...
    for (var r in t)
      dl(e, r, { get: t[r], enumerable: true });
  }, "We"), vm = a((e, t, r, n) => {
    if (t && typeof t == "object" || typeof t == "function")
      for (let o of dS(t))
        !hS.call(e, o) && o !== r && dl(e, o, { get: a(
          () => t[o],
          "get"
  ...
  bS = mS(() => {
    ...
    function o(m, g) {
      ...
      for (var x in m)
        if (x !== "default" && {}.hasOwnProperty.call(m, x)) {
    ...
    function f(m, g, y) {
      ...
      if (H)
        ...
        R === S ? R ? M[E] = [R, 0] : M[E] = true : M[E] = [R, S - R];
 ...
 `, C(x.gutter, T.replace(/\d/g, " ")), " ", U, C(x.marker, "^").repeat(z)].join(""), q && y.message && (N += " " + C(x.message, y.message));
          ...
          return ` ${C(x.gutter, T)}${M.length > 0 ? ` ${M}` : ""}`;
      }).join(`
`);
...
${H}`), w ? D4.reset(H) : H;
  ...
  zt.prototype = { diff: a(function(e, t) {
    ...
    function y() {
      for (var D4 = Math.max(m, -p); D4 <= Math.min(g, p); D4 += 2) {
        ...
        if (!S || R && C.oldPos + 1 < E.oldPos ? x = i.addToPath(E, true, void 0, 0) : x = i.addToPath(C, void 0, true, 1), b = i.extractCommon(
          ...
          return l(CS(i, x.lastComponent, t, e, i.useLongestToken));
    ...
    for (var o = t.length, i = r.length, l = e.oldPos, u = l - n, c = 0; u + 1 < o && l + 1 < i && this.equals(t[u + 1], r[l + 1]); )
      u++, l++, c++;
  ...
  xm.tokenize = function(e) {
    for (var t = e.split(/([^\S\r\n]+|[()[\]{}'"\r\n]|\b)/), r = 0; r < t.length - 1; r++)
      !t[r + 1] && t[r + 2] && V2.test(t[r]) && V2.test(
        t[r + 2]
...
`));
  ...
  qc = pA, dA = (go = class {
    ...
    findAncestor(t) {
      for (let r of Ba(this, Nr, sl).call(this))
        if (t(r))
          return r;
    }
    hasAncestor(t) {
...
in order for it to be formatted.`,
  ...
  jA = $A, fo = { key: a((e) => /^[$_a-zA-Z][$_a-zA-Z0-9]*$/.test(e) ? e : JSON.stringify(e), "key"), value(e) {
    ...
    if (Array.isArray(e))
      return `[${e.map((r) => fo.value(r)).join(", ")}]`;
    let t = Object.keys(e);
    ...
    _applyNormalization(t, r) {
      ...
      for (let l of o) {
        ...
        let p = a(({ from: f, to: v }) => {
          ...
          if (b !== false)
            if (b === true)
              this._hasDeprecationWarned(l) || this._utils.logger.warn(this._deprecatedHandler(l, v, this._utils));
            else
              for (let { value: m } of b) {
                let g = { key: l, value: m };
        ...
        for (let { from: f, to: v } of h7.redirect)
          d({ value: f, redirectTo: v });
      }
      for (let l of i) {
        let u = t[l];
      ...
      if (kB && e instanceof Map && t instanceof Map) {
        ...
        for (i = e.entries(); !(n = i.next()).done; )
          if (!t.has(n.value[0]))
            return false;
        for (i = e.entries(); !(n = i.next()).done; )
          if (!Xl(n.value[1], t.get(n.value[0])))
            return false;
        return true;
      }
...
function $k(e, { select: t = false } = {}) {
  ...
  for (let n of e)
    if (pr(n, { select: t }), document.activeElement !== r)
      return;
}
a($k, "focusFirst");
function jk(e) {
...
//# sourceMappingURL=chunk-JBPZSYO7.js.map
